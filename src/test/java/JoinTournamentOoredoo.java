...
public class JoinTournamentOoredoo extends BaseClass {
    ...
    public void TournamentJoin() {
        ...
        try {
            ...
            Thread.sleep(5000);
            driver.get("https://qa-hive-ooredoo-cicd.swarmio.gg/event/" + eventID);
            Thread.sleep(5000);
            System.out.println(Logbtns.JoinEvent());
            driver.close();
        } catch (Exception e) {
            System.out.println(e);
            util.writeCurrentPageSource("TournamentJoinOoredooFail.html");
        }
    }
}